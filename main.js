...
ctx.fillText("Happy Birthday, Emily! - The Lahey Bunch", width / 2, height / 2 - 100);
...
function animation() {
  ...
  if (firstFrame < 1401) {
    ...
    ctx.fillStyle = "Red";
    ctx.fillText("Emily", 20 + firstFrame, 100);
    ctx.fillStyle = "Orange";
    ctx.fillText("Emily", 1200 - firstFrame, 200);
    ctx.fillStyle = "Green";
    ctx.fillText("Emily", 20 + firstFrame, 300);
    ctx.fillStyle = "Blue";
    ctx.fillText("Emily", 1200 - firstFrame, 400);
